        ...
        <div class="card-body">
            <form action="{{ route('klien.update', $klien->id) }}" method="POST">
                ...
                <div id="form-personal" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" 
                               ...
                               value="{{ old('tanggal_lahir', $klien->tanggal_lahir ? $klien->tanggal_lahir->format('Y-m-d') : '') }}">
                        @error('tanggal_lahir')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="catatan" id="catatan" class="form-control @error('catatan') is-invalid @enderror" rows="3" placeholder="Masukkan catatan tambahan (opsional)">{{ old('catatan', $klien->catatan) }}</textarea>
                    @error('catatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    function toggleExclusive() {
        ...
        if (sertifikatTerbitMutual && sertifikatTerbitMutual.value) {
            if(statusManualMutual) {
                ...
                // Gunakan cara custom CSS/readonly visual karena select option 'disabled' bisa bikin tidak ter-submit dengan sempurna bagi old value
