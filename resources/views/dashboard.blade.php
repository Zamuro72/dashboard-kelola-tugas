                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Ongoing Proses Deal</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahKlienOngoingProsesDeal }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                Belum Jelas</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahKlienBelumJelas }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Follow Up</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahKlienFollowUp }}</div>
                        </div>
                        <div class="col-auto">
