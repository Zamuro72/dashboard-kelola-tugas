        ...
        <form action="{{ route('lemburStore') }}" method="post">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" name="departemen" class="form-control @error('departemen') is-invalid @enderror" value="{{ old('departemen') }}" placeholder="Masukkan Departemen/Divisi">
                            @error('departemen')
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" id="hari_display" class="form-control" readonly placeholder="Otomatis dari tanggal">
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                <input type="time" name="jam_kerja_mulai" class="form-control @error('jam_kerja_mulai') is-invalid @enderror" value="{{ old('jam_kerja_mulai', '08:00') }}">
                                <div class="input-group-prepend input-group-append">
                                    <span class="input-group-text">s.d.</span>
                                </div>
                                <input type="time" name="jam_kerja_selesai" class="form-control @error('jam_kerja_selesai') is-invalid @enderror" value="{{ old('jam_kerja_selesai', '17:00') }}">
                            </div>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                <input type="time" name="jam_lembur_mulai" id="jam_lembur_mulai" class="form-control @error('jam_lembur_mulai') is-invalid @enderror" value="{{ old('jam_lembur_mulai', '17:00') }}">
                                <div class="input-group-prepend input-group-append">
                                    <span class="input-group-text">s.d.</span>
                                </div>
                                <input type="time" name="jam_lembur_selesai" id="jam_lembur_selesai" class="form-control @error('jam_lembur_selesai') is-invalid @enderror" value="{{ old('jam_lembur_selesai', '20:00') }}">
                            </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_jam_lembur" class="form-control" readonly>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror" value="{{ old('lokasi') }}" placeholder="Masukkan lokasi lembur">
                            @error('lokasi')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-12">
                            <textarea name="uraian_pekerjaan" rows="5" class="form-control @error('uraian_pekerjaan') is-invalid @enderror" placeholder="Jelaskan pekerjaan yang akan dilaksanakan selama lembur...">{{ old('uraian_pekerjaan') }}</textarea>
