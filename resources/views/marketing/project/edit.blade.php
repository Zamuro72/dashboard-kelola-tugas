...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('marketing.project.update', $project->id) }}" method="post">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="skema" class="form-control @error('skema') is-invalid @enderror" 
                           value="{{ old('skema', $project->skema) }}" placeholder="Masukkan nama skema">
                    @error('skema')
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" 
                           value="{{ old('tanggal', $project->tanggal->format('Y-m-d')) }}">
                    @error('tanggal')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <input type="text" name="timeline" class="form-control @error('timeline') is-invalid @enderror" 
                           value="{{ old('timeline', $project->timeline) }}" placeholder="Contoh: 2 minggu, 1 bulan, dll">
                    @error('timeline')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
